...
describe('CurationsLogic', () => {
  ...
  const { clearFlashMessages, flashSuccessCallout, flashAPIErrors } = mockFlashMessageHelpers;
  ...
  describe('listeners', () => {
    ...
    describe('deleteCuration', () => {
      ...
      it('should make an API call and show a success message', async () => {
        ...
        expect(flashSuccessCallout).toHaveBeenCalledWith('Successfully removed curation.');
      });
